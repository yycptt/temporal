...
// Marshal an object of type ClosePayloadStoreRequest to the protobuf v3 wire format
func (val *ClosePayloadStoreRequest) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type ClosePayloadStoreRequest from the protobuf v3 wire format
func (val *ClosePayloadStoreRequest) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *ClosePayloadStoreRequest) Size() int {
	return proto.Size(val)
}

// Equal returns whether two ClosePayloadStoreRequest values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *ClosePayloadStoreRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *ClosePayloadStoreRequest
	switch t := that.(type) {
	case *ClosePayloadStoreRequest:
		that1 = t
	case ClosePayloadStoreRequest:
		that1 = &t
	default:
...
// Marshal an object of type ClosePayloadStoreResponse to the protobuf v3 wire format
func (val *ClosePayloadStoreResponse) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type ClosePayloadStoreResponse from the protobuf v3 wire format
func (val *ClosePayloadStoreResponse) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *ClosePayloadStoreResponse) Size() int {
	return proto.Size(val)
}

// Equal returns whether two ClosePayloadStoreResponse values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *ClosePayloadStoreResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *ClosePayloadStoreResponse
	switch t := that.(type) {
	case *ClosePayloadStoreResponse:
		that1 = t
	case ClosePayloadStoreResponse:
		that1 = &t
	default:
