...
//
//	mockgen -package historyservicemock -source api/historyservice/v1/service_grpc.pb.go -destination api.new/temporal/server/api/historyservicemock/v1/service_grpc.pb.mock.go
//
